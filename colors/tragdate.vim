...
let s:N1 = [ '#e2e2e2' , '#4c0be3' , 254 , 56  ]
let s:N2 = [ '#1fffff' , '#242322' , 206 , 234 ]
let s:N3 = [ '#f9ac53' , '#4a4a4a' , 254 , 238 ]
...
let s:I1 = [ '#242322' , '#1fffff' , 234 , 111 ]
let s:I2 = [ '#f9ac53' , '#242322' , 80  , 234 ]
...
let g:airline#themes#kolor#palette.insert_modified = {
      \ 'airline_c': [ '#242322' , '#1fffff' , 234     , 111     , ''     ] ,
      \ }
...
let s:V1 = [ '#242322' , '#f9ac53' , 234 , 180 ]
let s:V2 = [ '#f9ac53' , '#242322' , 186 , 234 ]
let s:V3 = [ '#1fffff' , '#4a4a4a' , 254 , 238 ]
